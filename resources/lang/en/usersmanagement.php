...
return [
    ...
    // Titles
    'showing-all-users'     => 'Showing All Student',
    'users-menu-alt'        => 'Show Student Management Menu',
    'create-new-user'       => 'Create New Student',
    'show-deleted-users'    => 'Show Deleted Student',
    'editing-user'          => 'Editing Student :name',
    'showing-user'          => 'Showing Student :name',
    ...
    'usersBackBtn'           => 'Back to Student',
    'usersPanelTitle'        => 'Student Information',
    ...
    'errorUserNotFound' => 'Student not found.',
    ...
    'buttons' => [
        'create-new'    => 'New Student',
        'delete'        => '<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i>  <span class="hidden-xs hidden-sm">Delete</span><span class="hidden-xs hidden-sm hidden-md"> Student</span>',
        'show'          => '<i class="fa fa-eye fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm">Show</span><span class="hidden-xs hidden-sm hidden-md"> Student</span>',
        'edit'          => '<i class="fa fa-pencil fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm">Edit</span><span class="hidden-xs hidden-sm hidden-md"> Student</span>',
        'back-to-users' => '<span class="hidden-sm hidden-xs">Back to </span><span class="hidden-xs">Students</span>',
        'back-to-user'  => 'Back  <span class="hidden-xs">to Student</span>',
        'delete-user'   => '<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i>  <span class="hidden-xs">Delete</span><span class="hidden-xs"> Student</span>',
        'edit-user'     => '<i class="fa fa-pencil fa-fw" aria-hidden="true"></i> <span class="hidden-xs">Edit</span><span class="hidden-xs"> Student</span>',
    ],
    ...
    'tooltips' => [
        ...
        'show'          => 'Show',
        'edit'          => 'Edit',
        'create-new'    => 'Create New Student',
        'back-users'    => 'Back to student',
